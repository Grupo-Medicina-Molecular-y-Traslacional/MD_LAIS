...
import tomocomd.camps.mdlais.gui.ui.IListDialog4KMers;

/**
 *
 * @author yasilvalmeida
 */
public class ListDialog4KMers extends javax.swing.JDialog 
{
    final private IListDialog4KMers dialog;
    
    public ListDialog4KMers( String title, java.awt.Dialog parent, boolean modal, IListDialog4KMers dialog )
    {
        super( parent, modal );
    ...
    private void jList1ValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jList1ValueChanged
        ...
        {
            dialog.updateKMerList(jList1.getSelectedValue().toString() );
        }
    ...
    private void jButtonRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRemoveActionPerformed
        ...
        {
            dialog.removeKMer(item.toString() );
        });
